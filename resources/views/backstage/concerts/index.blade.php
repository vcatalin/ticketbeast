                                ...
                                <div class="card-section">
                                    <div class="m-xs-b-4">
                                        ...
                                        <p class="text-sm m-xs-b-2">
                                            <x-zondicon-location class="zondicon-sm text-dark-soft m-xs-r-1" />
                                            {{ $concert->venue }} &ndash; {{ $concert->city }}, {{ $concert->state }}
                                        </p>
                                        <p class="text-sm">
                                            <x-zondicon-calendar class="zondicon-sm text-dark-soft m-xs-r-1" />
                                            {{ $concert->formatted_date }} @ {{ $concert->formatted_start_time }}
                                        </p>
                                    </div>
                                    <div>
                                        {{-- TODO Add URL when manage published concert feature is in place --}}
                            ...
                            <div class="card m-xs-b-4">
                                <div class="card-section">
                                    ...
                                    <div>
                                        ...
                                        {{-- TODO Add action when publish concert feature is in place --}}
