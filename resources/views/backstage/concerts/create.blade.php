...
@section('backstageContent')
    ...
    <form action="/backstage/concerts" class="bg-soft p-xs-y-5" method="POST" enctype="multipart/form-data">
        {{ csrf_field() }}
                        ...
                        <div class="card">
                            <div class="card-section">
                                <div class="form-group {{ $errors->first('title', 'has-error') }}">
                                    ...
                                    <input type="text" class="form-control" name="title" value="{{ old('title') }}" placeholder="The Headliners">
                                </div>
                                <div class="form-group {{ $errors->first('subtitle', 'has-error') }}">
                                    <label for="subtitle" class="form-label">Subtitle</label>
                                    <input type="text" class="form-control" name="subtitle" value="{{ old('subtitle') }}" placeholder="with The Openers (optional)">
                                </div>
